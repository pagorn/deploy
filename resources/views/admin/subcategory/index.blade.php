  ...
  <a href="report" class="btn btn-primary " role="button" aria-pressed="true">รายงานผล</a>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col">
                <div class="card">
                    <div class="card-header">จัดการโครงสร้างหมวดวิชา</div>
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>รหัสหมวดวิชา</th><th>ชื่อหมวดวิชา</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($subcategory as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ url('/admin/subcategory/' . $item->id . '/edit') }}" title="Edit subcategory"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
