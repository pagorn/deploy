            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ url('admin/courses' . '/' . $course->id) }}" accept-charset="UTF-8" style="display:inline">
                            {{ method_field('DELETE') }}
                            {{ csrf_field() }}
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Title </th><td> {{ $course->title }} </td></tr><tr><th> Content </th><td> {{ $course->content }} </td></tr><tr><th> Category </th><td> {{ $course->category }} </td></tr>
                                </tbody>
                            </table>
                        </div>
