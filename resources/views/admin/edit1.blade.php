...
@section('content')
  ...
  <div class="table-responsive">
    ...
    @endforeach
                        ...
                        <form method="POST" action="{{ url('/admin/report1/' . $report->id) }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                            {{ method_field('PATCH') }}
                            {{ csrf_field() }}
...
<div class="form-group {{ $errors->has('edit1') ? 'has-error' : ''}}">
    <label for="edit1" class="control-label">{{ 'edit1' }}</label>
    <input hidden readonly class="form-control" name="edit1" type="text" id="edit1" value="0" >
    {!! $errors->first('edit1', '<p class="help-block">:message</p>') !!}
</div>
