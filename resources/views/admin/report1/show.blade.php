...
<div class="table-responsive">
                        <table  class="table table-striped">
                                <thead>
                                    <tr>
                                    <th>โครงสร้างหลักสูตร</th><th>จำนวนหน่วยกิตตามเกณฑ์</th><th>จำนวนหน่วยกิตที่ลงทะเบียน</th><th>จำนวนหน่วยกิตที่ยังขาด</th><th>GPA</th><th>เงื่อนไข</th>
                                    </tr>
                                </thead>
                                <tbody>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col">
                <div class="card">
                    <div class="card-header"><h5>หมวดวิชาทั่วไป กลุ่มวิชาภาษา <b>หน่วยกิตที่ลงทะเบียน {{ $count_credit_1}} หน่วยกิต GPA {{ number_format($gpa_credit_1, 2)}}</h5></div>
                    <div class="card-body">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col">
                <div class="card">
                    <div class="card-header"><h5>หมวดวิชาทั่วไป กลุ่มวิชามนุษยศาสตร์และสังคมศาสตร์ <b>หน่วยกิตที่ลงทะเบียน {{ $count_credit_2}} หน่วยกิต GPA {{ number_format($gpa_credit_2, 2)}}</h5></div>
                    <div class="card-body">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col">
                <div class="card">
                    <div class="card-header"><h5>หมวดวิชาทั่วไป กลุ่มคณิตศาสตร์และวิทยาศาสตร์ <b>หน่วยกิตที่ลงทะเบียน {{ $count_credit_3}} หน่วยกิต GPA {{ number_format($gpa_credit_3, 2)}}</h5></div>
                    <div class="card-body">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col">
                <div class="card">
                    <div class="card-header"><h5>หมวดวิชาเฉพาะ กลุ่มวิชาพื้นฐาน <b>หน่วยกิตที่ลงทะเบียน {{ $count_credit_4}} หน่วยกิต GPA {{ number_format($gpa_credit_4, 2)}}</h5></div>
                    <div class="card-body">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col">
                <div class="card">
                    <div class="card-header"><h5>หมวดวิชาเฉพาะ หมวดวิชาบังคับ <b>หน่วยกิตที่ลงทะเบียน {{ $count_credit_6}} หน่วยกิต GPA {{ number_format($gpa_credit_6, 2)}}</h5></div>
                    <div class="card-body">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col">
                <div class="card">
                    <div class="card-header"><h5>หมวดวิชาเฉพาะ หมวดวิชาเลือก <b>หน่วยกิตที่ลงทะเบียน {{ $count_credit_7}} หน่วยกิต GPA {{ number_format($gpa_credit_7, 2)}}</h5></div>
                    <div class="card-body">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col">
                <div class="card">
                    <div class="card-header"><h5>หมวดวิชาเลือกเสรี <b>หน่วยกิตที่ลงทะเบียน {{ $count_credit_8}} หน่วยกิต GPA {{ number_format($gpa_credit_8, 2)}}</h5></div>
                    <div class="card-body">
