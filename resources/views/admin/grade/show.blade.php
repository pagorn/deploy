...
<body>
    ...
    <div id="page-content">
            ...
            <tbody>
                <tr>
                    <td align="center" style="width: 33%;">
                        <div>
                            <div>
                                การทดสอบคอมพิวเตอร์ของสำนักนวัตกรรมการเรียนการสอน
                            </div>
                        </div>
                    </td>
                    <td align="center" style="width: 33%;">
                        <div>
                            <div>
                                หน่วยกิจกรรมครบ 5 ด้าน 60 หน่วยกิจกรรม
                            </div>
                        </div>
                    </td>
                    <td align="center" style="width: 33%;">
            ...
            <tbody>
                <tr>
                    <td style="width: 33%;">
                        <div>
                            <div>
                                <center>จำนวนหน่วยกิตรวมขั้นต่ำ: {{$credit_sum}}
                            </div>
                        </div>
                    </td>
                    <td style="width: 33%;">
                        <div>
                            <div>
                                <center>เกรดเฉลี่ยรวมไม่ต่ำกว่า: 2.00
                            </div>
                        </div>
                    </td>
                    <td style="width: 33%;">
                        <div>
                            <div>
                                <center>เกรดเฉลี่ยเฉพาะหลักสูตรไม่ต่ำกว่า: 2.00
                            </div>
                        </div>
                    </td>
                </tr>
                <tr>
                    <td style="width: 33%;">
                        <center>จำนวนหน่วยกิตที่ได้: {{ $sum_credit}}
                    </td>
                    <td style="width: 33%;">
                        <center>เกรดเฉลี่ยรวมที่ได้: {{ number_format($sum_all/$sum_credit, 2)}}
                    </td>
                    <td style="width: 33%;">
                        <center>เกรดเฉลี่ยรวมที่ได้: {{ number_format($gpa_cat_2/$count_2, 2)}}
                    </td>
                </tr>
                <tr>
                    <td style="width: 33%;">
                        <center>@foreach($course_detail as $item)
                    ...
                    <td style="width: 33%;">
                        <center>@foreach($course_detail as $item)
                            @if(($sum_gpa_1)<2) <center> <b>ผ่าน</b>
                                @else
                                <b>ไม่ผ่าน</b> </center>
                        @endif
                        @endforeach
        ...
        <center><b>ข้อมูลนักศึกษา</b></center><br>
