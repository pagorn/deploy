...
<body>
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
    ...
    <a class="dropdown-item" href="create1">บันทึกผลเกรดหมวดเลือกเสรี</a>

  </div>
  <a href="report/create" class="btn btn-primary " role="button" aria-pressed="true">ส่งผลรายงานผล</a>
            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ url('/admin/grade/' . $grade->id) }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                            {{ method_field('PATCH') }}
                            {{ csrf_field() }}
